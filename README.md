...
* **clockfield\_lab.html**: The 2D interactive WebGL browser simulation. Allows real-time injection of vortex dipoles, fermions, and wave pulses to observe the $\\Gamma$-shell freeze in real-time.  
